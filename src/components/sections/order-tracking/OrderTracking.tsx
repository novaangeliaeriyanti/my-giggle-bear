  ...
  return (
    <div className="max-w-3xl container mx-auto p-4 space-y-4">
      ...
      <div className="flex flex-col gap-2 text-small">
        ...
        <span className="font-medium">Courier: <span className="font-bold">{tracking.courier}</span></span>
        <span >Tracking Number: <span className="font-bold">{tracking.trackingNumber}</span></span>
        <span >
          Estimated Delivery: <span className="font-bold">{tracking.estimatedDelivery}</span>
        </span>
        <div className="flex items-center gap-2">
          <CheckCircle2 size={18} className="text-primary" />
          <span className="text-small">Current Status: <span className="font-bold text-primary">{tracking.currentStatus}</span></span>
        </div>
      </div>
