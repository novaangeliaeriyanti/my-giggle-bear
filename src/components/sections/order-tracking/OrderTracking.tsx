...
const OrderTracking = () => {
  ...
  return (
    <div className="max-w-5xl container mx-auto p-4 space-y-4">
        ...
        <div className="flex flex-col gap-2 text-small">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-small">
              Current Status:{" "}
              <span className="font-bold text-primary">{tracking.currentStatus}</span>
            </span>
          </div>
        </div>
        <div className="relative bg-primary/5 card-rounded p-4">
