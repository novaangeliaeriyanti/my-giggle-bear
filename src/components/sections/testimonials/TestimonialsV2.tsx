          ...
          {reviews?.items?.map((review) => (
            <div
              ...
              className="
                ...
                bg-blue-sky bg-[url(/images/icons/grid-line.png)] bg-[length:720px]
                card-rounded border border-gray-200 
                flex flex-col
              "
            >
              ...
              <div className="flex flex-col gap-3 h-full">
                <div className="flex items-center gap-2 p-4 pb-0">
                  ...
                  />
                  <span className="text-body text-secondary line-clamp-2 mt-2 text-stroke text-heading-1">
                    {review.name}
                  </span>
                </div>

                <div className="bg-white flex-1 p-4 card-rounded">
                  <div className="text-small line-clamp-3">“{review.comment}”</div>
                </div>
              </div>
            </div>
          ))}
