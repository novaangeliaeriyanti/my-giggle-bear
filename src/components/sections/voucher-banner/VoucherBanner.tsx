...
const VoucherBanner = () => {
  ...
  return (
    <div className="flex justify-center container mx-auto p-4 mt-8">
      <div className="relative w-full bg-blue-sky text-primary card-rounded bg-[url(/images/icons/grid-line.png)] bg-[length:720px] overflow-visible flex items-center">
