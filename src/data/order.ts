...
export const order = {
  ...
  status: "Delivered",
  items: [
    { id: 1, name: "Cotton T-shirt", qty: 2, sizes:"m", colors:"gray", images:"/images/products/7g.png", price: 75000 },
    { id: 2, name: "Denim Jeans", qty: 1, sizes:"xl", colors:"blue", images:"/images/products/8b.png", price: 250000 },
  ],
  shipping: {
    name: "John Doe",
